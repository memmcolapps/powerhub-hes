...
public class HouseholdManagementTokenEventCustomRepository {

    private final EntityManager entityManager;

    public List<Object[]> findExistingEvents(String meterSerial, List<HouseholdManagementTokenEventDTO> dtos) {

...
public class HouseholdFraudEventCustomRepository {

    private final EntityManager entityManager;

    public List<Object[]> findExistingEvents(String meterSerial, List<HouseholdFraudEventDTO> dtos) {
